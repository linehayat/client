  ...
  <>
    ...
    <div className={styles.main}>
      ...
      <div>
        ...
        <p>At LineHayat, confidentiality is our utmost priority. Under no circumstance will our Listening Volunteers disclose your information or the content of your sharing with any third parties. All conversations will be automatically deleted when the chat ends. No data will be stored or kept regardless of whether if they were communicated to us through calls or messages.</p>
      </div>
      <div>
      ...
      <div>
        <h2>Disclaimer</h2>
        <p>LineHayat is a helpline run by trained volunteers. We are trained to provide an anonymous and confidential listening ear to Sharers who need it. The output from our volunteers should not be used as a substitute for professional mental health advice. Due to our limitations, our Listening Volunteers also do not practise crisis intervention, referrals or follow-ups.</p>
        <p>LineHayat will not be held liable or responsible for any consequences, actions, or incidents upon whoever has used our services. However, if you need any guidance in reaching out for professional mental health help, our Listening Volunteers will be ready to channel you to those resources depending on your individual circumstances.</p>
      </div>
    </div>
  </>
);
